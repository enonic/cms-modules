...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:portal="http://www.enonic.com/cms/xslt/portal"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9  http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd" xmlns:stk="http://www.enonic.com/cms/xslt/stk">
  ...
  -->
    ...
    <xsl:template match="menuitem | content">
        <xsl:if test="name() = 'content' or (name() = 'menuitem' and @key != $stk:current-resource/@key and @key != $stk:error-page)">
            <url>
                <loc>
